...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    */
    ...
    $sql_insert = "INSERT INTO usuarios (nombre, apellido, cedula, edad, telefono, email, password) VALUES ('$nombre', '$apellido', '$cedula', '$edad', '$telefono', '$email', '$password_encriptada')";
